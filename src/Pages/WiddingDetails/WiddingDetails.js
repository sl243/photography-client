    ...
    return (
        <div className='flex'>
            <div className='w-1/2'>
                ...
                <p className='text-xl p-5 text-justify'>
                We are the best wedding photographer in Bangladesh who offer value for your money as all our professional photographers offer their impeccable skills on your big day. Being the best wedding photography, we seek to bring out the pomp and color on your special day and make you feel really special!
                </p>
            </div>
